...
const TASKS = [
  mk({ title: 'Revisar o pipeline de ETL antes do deploy', project: 'estudos', col: 'doing', prio: 3, due: TODAY, time: '14:00', tags: ['foco', 'profundo'], est: 90, today: true,
       subtasks: [{ id: 's1', title: 'Conferir schema das tabelas novas', done: true, prio: 2, notes: '' }, { id: 's2', title: 'Rodar testes de carga', done: false, prio: 3, notes: 'Usar o dataset de 10M de linhas; medir o p95.' }, { id: 's3', title: 'Validar com o time no Slack', done: false, prio: 1, notes: '' }] }),
  ...
  mk({ title: 'Ligar pra vó no fim de semana', project: 'social', col: 'todo', prio: 2, due: isoAdd(TODAY, 2), tags: ['ligar'], est: 30 }),
  ...
  mk({ title: 'Confirmar presença no aniversário da Lia', project: 'social', col: 'week', prio: 1, due: isoAdd(TODAY, 3), tags: ['recados', '5min'], est: 5 }),
