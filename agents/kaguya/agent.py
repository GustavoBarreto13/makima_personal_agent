...
# Lista de tools de tarefas (extraída para agents/kaguya/toolset.py na spec 064 —
...
def create_kaguya_agent() -> Agent:
    ...
    return Agent(
        ...
        # Tools de tarefas (agents/kaguya/toolset.py) + agenda (Google Calendar via MCP)
        tools=[*_KAGUYA_TOOLS, mcp_calendar],
    )
