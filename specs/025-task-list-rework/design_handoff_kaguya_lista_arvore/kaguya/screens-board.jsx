...
function KanbanScreen({ onComplete, onOpen, onUpdate, onNew, onToast }) {
  ...
  const colTasks = (col) => TASKS.filter(t => inScope(t) && !t.parent && t.col === col.id && (col.isDone ? t.done : !t.done))
  ...
  return (
    <div className="page wide">
      ...
      <div className="board">
        ...
        {(() => {
          const open = TASKS.filter(t => inScope(t) && !t.parent && !t.done);
          const doing = TASKS.filter(t => inScope(t) && !t.parent && t.col === 'doing' && !t.done);
