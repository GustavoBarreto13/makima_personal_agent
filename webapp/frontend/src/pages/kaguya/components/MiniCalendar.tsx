// MiniCalendar — grade de calendário mensal reutilizável, no tema Kaguya.
//
...
//
// Diferença do mini-mês em CalendarsAside: este componente NÃO tem a "faixa
// de semana" (.in-week / .wk-start / .wk-end) porque ela é específica do
// Calendar Hub. Aqui só marcamos .today (hoje) e .sel (data selecionada).
//
// Props:
...
import { toISO, addDays, todayISO, MONTHS_PT, WEEKDAY_1 } from '../lib/dateUtils'
